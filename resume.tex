...
\newcommand{\resitem}[1]{\item #1 \vspace{-2pt}}
	...
	\begin{itemize}
		...
		\item[]
			...
			\begin{itemize}
					...
					\resitem{{\em Server Infrastructure}: AWS, Supervisor, Apache, Nginx, Docker, Vagrant, Virtualenv, Cron}
					...
					\resitem{{\em Architectures}: Scalable, Microservices, Monolithic}
	...
	\begin{itemize}
		...
		\item[]
			...
			\begin{itemize}
					\resitem{Engineered projects to handle high capacities using microservice architecture and dynamic scaling.}
