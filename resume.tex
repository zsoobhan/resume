...
\newcommand{\resitem}[1]{\item #1 \vspace{-2pt}}
    ...
    \begin{itemize}
        ...
        \item[]
            \resdescription{Performed complex data analysis in Python (Numpy and Matplotlib) for data collected using astronomical equipment (e.g.\ telescope, thermoelectrically cooled cameras) and produced Colour-Magnitude Diagrams.}
